...
@Component({
  selector: 'app-home',
  imports: [HeaderComponent, MainComponent, BrandsCategoriesComponent, AboutComponent, FooterComponent, DayDealComponent, BrandNewComponent, BestOfSectionComponent],
